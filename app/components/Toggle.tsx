  ...
  return (
    <div className="flex flex-col items-center">
      <div className="text-xs font-extrabold leading-tight text-black text-center">
        {checked ? (
          <span className="font-bold text-base text-green-600">VEG</span>
        ) : (
            // strike the veg 
          <span className="font-bold text-base text-green-600 line-through decoration-red-600">VEG</span>
        )}
        <br />
        <span className="font-bold text-black">MODE</span>
      </div>
      <div
